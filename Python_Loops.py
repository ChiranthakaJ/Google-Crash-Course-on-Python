...
'''Since this gives an error because of the get_members(), it doesn't say this is wrong. This is a part of a much larger program. In the training program this is correct.'''
